...
def apply_template!
  ...
  after_bundle do
    ...
    # Apply other variants after setup and initial install, but before commit
    apply "../accessibility/template.rb"
    apply "../frontend-foundation/template.rb" if apply_variant?(:foundation)
    apply "../sidekiq/template.rb" if apply_variant?(:sidekiq)
    ...
    apply "../devise/template.rb" if apply_variant?(:devise)
  end
end
