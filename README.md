...
- `--skip_javascript` skips the setup of JavaScript imports/compilers, Rails
...
It also applies the [foundation-layout variant](#foundation-layout), if this
option is specified during setup.
